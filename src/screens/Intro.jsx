...
export default function Intro({ onNext }) {
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-primary-soft/50 via-background-light to-background-light dark:from-background-dark dark:via-background-dark dark:to-background-dark flex flex-col items-center">
      {/* Background Floating Hearts (Decorative) - Moved to fill the screen */}
      ...
      {/* Content Container */}
      <div className="relative z-10 h-full w-full max-w-md flex flex-col items-center justify-between p-6">
